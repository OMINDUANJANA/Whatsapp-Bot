...
DATABASE_URL = process.env.DATABASE_URL === undefined ? './smarthelp.db' : process.env.DATABASE_URL;
DEBUG = process.env.DEBUG === undefined ? false : convertToBool(process.env.DEBUG);

module.exports = {
    VERSION: 'rs-smart-help 2.0.0 - Full Control',
    CHANNEL: ',
    SESSION: process.env._SMART_HELP_SESSION === undefined ? '' : process.env._SEW_QUEEN_SESSION,
    ...
    PROXY: process.env.PROXY === undefined ? 'true' : process.env.PROXY,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    DEEPAI: process.env.DEEP_AI === undefined ? '09010100-625c-46c4-b226-8f9a5e6e548f' : process.env.DEEP_AI,
    ABT: process.env.AUTO_BİO_ABOUT === undefined ? 'Coded By Omindu Anjana' : process.env.AUTO_BİO_ABOUT,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'Smart Help' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
    TEXT: process.env.TEXTTEXTTEXT === undefined ? 'SEWS' : process.env.TEXTTEXTTEXT.toUpperCase(),
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'Coded By Omindu Anjana \n\n \nt.me/SmartHelp\n\n' : process.env.ALIVE_MESSAGE,
    ...
    DATABASE: DATABASE_URL === './smarthelp.db' ? new Sequelize({ dialect: "sqlite", storage: DATABASE_URL, logging: DEBUG }) : new Sequelize(DATABASE_URL, { dialectOptions: { ssl: { require: true, rejectUnauthorized: false } }, logging: DEBUG }),
