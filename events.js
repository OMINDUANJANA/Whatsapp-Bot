...
function newcmdaddtoSMART(info, func) {
   
    var types = ['photo', 'image', 'text', 'message'];

    var infos = {
        fromMe: info['fromMe'] === undefined ? true : info['fromMe'], // Or Sudo
        onlyGrpSMART: info['onlyGrpSMART'] === undefined ? false : info['onlyGrpSMART'],
        onlyPinned: info['onlyPinned'] === undefined ? false : info['onlyPinned'],
        onlyPm: info['onlyPm'] === undefined ? false : info['onlyPm'],
        delownSMARTcmd: info['delownSMARTcmd'] === undefined ? true : info['delownSMARTcmd'],
...
module.exports = {
    newcmdaddtoSMART: newcmdaddtoSMART,
    commands: Commands
}
